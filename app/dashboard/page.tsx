...
export default function Page() {
  return (
    <PageFormat breadCrumbs={[]}>
      ...
      <div className="mt-4 flex sm:flex-col flex-row gap-4">
        <Section
          id="evaluate"
          title="Jump on in!"
        ...
        >
          <Link href={"/dashboard/evaluate"}>
            ...
            <div className="flex flex-row justify-end pt-28 overflow-hidden">
              <Image
                src={"./teapot.svg"}
                alt={"a teapot"}
                width="500"
                height="500"
                className="absolute right-0 scale-x-[-1] z-10 group-hover:rotate-6 group-hover:scale-y-[1.05] ease-out duration-200"
              />
              <div className="bg-[#ac795d] w-[80%] h-[30vh] z-0 rounded-lg group-hover:scale-105 duration-500"></div>
            </div>
          </Link>
        </Section>
      </div>
